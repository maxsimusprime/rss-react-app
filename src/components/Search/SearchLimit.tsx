...
export default function SearchLimit() {
  ...
  return (
    ...
    >
      ...
      <button data-testid={'page-size-10'} onClick={() => setLimitHandle(10)}>
        10
      </button>
      <button data-testid={'page-size-20'} onClick={() => setLimitHandle(20)}>
        20
      </button>
      <button data-testid={'page-size-50'} onClick={() => setLimitHandle(50)}>
        50
      </button>
    </div>
  );
